...
class GenericReader(object, prefix):
    def __init__(self):
        self.files = {}
        self.fixed = {}
        self.prefix = prefix
        ...
        for i in self.consenses_entries:
            ...
            for d in self.dict_dict:
                try:
                    ...
                    self.master_collection["cms_page"][i] = [i, create_by, create_by, null, create_date, create_date, null, null, 0,0,null,null, 0,"entry_template.html", 1,0,1,2,1,0,null, 1, null, 1 ] 
                    self.master_collection["cms_title"][i] = [i, language, self.identifier[i], null, slug, self.identifier[i], "0", null, null, null, null, null,i,create_date ]
